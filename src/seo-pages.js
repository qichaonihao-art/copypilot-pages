...
export const seoPages = [
  page('/', 'zh-CN', 'home', 'blue', '免费在线内容提取工具', '视频解析与逐字稿提取', '支持抖音、快手、小红书等多平台链接解析，自动预览视频、提取发布文案，并识别视频语音逐字稿。', [
  ...
  page('/reader', 'zh-CN', 'reader', 'amber', '抖音图文阅读', '抖音图文阅读器', '粘贴多个抖音图文链接，自动提取配文并连成一篇方便阅读的合集，支持复制全文。', [
    '抖音图文阅读', '抖音图文文案提取', '抖音图文合集阅读', '图文配文提取'
  ]),
